...
from (values
  ...
  ('WOTEST8-DECLINE',         '069', 'Refrigeration', 'Refrigeration equipment',  'Active visit leaves capital review', 'p2', 'assigned',                  'Dispatched',                  :'company_admin_id'::uuid,   4200::numeric, false, null,                    false, null::timestamptz,              null::timestamptz,              :'invoice_tech_id'::uuid, 'Synthetic Invoice Technician', 0, 0::bigint, null::timestamptz),
  ('WOTEST8-INVOICE-FIRST',   '070', 'HVAC',          'HVAC',                     'Invoice precedes field lifecycle',    'p2', 'assigned',                  'Dispatched',                  :'direct_id'::uuid,          3200::numeric, false, null,                    false, null::timestamptz,              null::timestamptz,              null::uuid, 'Synthetic Direct Contractor', 0, 0::bigint, null::timestamptz),
  ('WOTEST8-STALE-CAPITAL',   '071', 'Refrigeration', 'Refrigeration equipment',  'Stale start after capital flag',      'p1', 'assigned',                  'Dispatched',                  :'direct_id'::uuid,          5200::numeric, false, null,                    false, null::timestamptz,              null::timestamptz,              null::uuid, 'Synthetic Direct Contractor', 0, 0::bigint, null::timestamptz),
  ('WOTEST8-STALE-TRANSFER',  '072', 'General',       'General Maintenance',      'Stale start after reassignment',      'p2', 'assigned',                  'Dispatched',                  :'direct_id'::uuid,          1800::numeric, false, null,                    false, null::timestamptz,              null::timestamptz,              null::uuid, 'Synthetic Direct Contractor', 0, 0::bigint, null::timestamptz),
  ('WOTEST8-CONCURRENT',      '073', 'Refrigeration', 'Refrigeration equipment',  'Concurrent field command sequence',  'p2', 'assigned',                  'Dispatched',                  :'direct_id'::uuid,          2600::numeric, false, null,                    false, null::timestamptz,              null::timestamptz,              null::uuid, 'Synthetic Direct Contractor', 0, 0::bigint, null::timestamptz),
  ('WOTEST8-BILLED-CAPITAL',  '074', 'Refrigeration', 'Refrigeration equipment',  'Completed billing enters capital',    'p1', 'assigned',                  'Dispatched',                  :'direct_id'::uuid,          6800::numeric, false, null,                    false, null::timestamptz,              null::timestamptz,              null::uuid, 'Synthetic Direct Contractor', 0, 0::bigint, null::timestamptz),
  ('WOTEST8-CAP-TRANSFER',    '075', 'HVAC',          'HVAC',                     'Capital visit emergency transfer',   'p1', 'assigned',                  'Dispatched',                  :'direct_id'::uuid,          7500::numeric, false, null,                    false, null::timestamptz,              null::timestamptz,              null::uuid, 'Synthetic Direct Contractor', 0, 0::bigint, null::timestamptz),
  ('WOTEST8-DECLINE-PAUSED',  '076', 'Refrigeration', 'Refrigeration equipment',  'Paused visit leaves capital review', 'p2', 'assigned',                  'Dispatched',                  :'company_admin_id'::uuid,   4300::numeric, false, null,                    false, null::timestamptz,              null::timestamptz,              :'invoice_tech_id'::uuid, 'Synthetic Invoice Technician', 0, 0::bigint, null::timestamptz),
  ...
  ('E2E-VISIT-FUTURE-OPEN',  '088',  'Refrigeration', 'Refrigeration equipment',  'Legacy future-open visit interval',   'p3', 'wip',                       'Work in Progress',            :'direct_id'::uuid,          1800::numeric, false, null,                    false, now() + interval '2 hours',  null::timestamptz,              null::uuid, 'Synthetic Direct Contractor', 0, 1::bigint, null::timestamptz)
) as fixture(
...
values
  ...
  (
    '00000000-0000-4000-8000-00000000f216', 'E2E-VISIT-FUTURE-OPEN',
    :'direct_id'::uuid, now() + interval '2 hours', null,
    :'direct_id'::uuid, null
  );

...
const PORTAL_STATUS_HELP = [
  ...
  ["pending_invoice", "P1 billing submission is pending; field status is tracked separately."],
  ["pending_approval", "An invoice is waiting for P1 review; field status is tracked separately."],
